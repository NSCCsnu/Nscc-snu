...
export const Footer = () => {
  return (
    <div>
        <footer class="p-4 x  md:p-8 lg:p-10 bg-gray-800">
  <div class="mx-auto max-w-screen-xl text-center">
      <a href="#" class="flex justify-center items-center text-2xl font-semibold text-white">
      <a href="https://flowbite.com" class="flex items-center">
                <img src="https://nscc-snu.netlify.app/assets/ethereal-2.0/logo.png" class="mr-3 h-8 sm:h-16 rounded-lg" alt="Flowbite Logo" />
                <span class="self-center text-xl font-semibold whitespace-nowrap darkno:text-white">NSCC-SNU</span>
            </a> 
      </a>
